 ...
 * 
 * File generated: Tue May 25 07:32:22 GMT 2010
 */
...
(function(a){function c(b,c){var d=a(c);return d.length<2?d:b.parent().find(c)}var b=a.tools.scrollable;b.pager={conf:{pager:".pager",pagerItem:".shelfItem"}};a.fn.pager=function(d){if(typeof d=="string"){d={navi:d}}d=a.extend({},b.pager.conf,d);var e;this.each(function(){function h(){var c=a(d.pagerItem,b.getRoot()),e=a(b.getItems()[b.getIndex()]),g=a(d.pagerItem,e),h=c.index(g[0])+1,i=c.index(g[g.length-1])+1;return f.text(h==i?h+" / "+c.length:h+"–"+i+" / "+c.length)}var b=a(this).data("scrollable"),f=d.pager.jquery?d.pager:c(b.getRoot(),d.pager),g=b.getConf().size;if(b){e=b}h();b.onSeek(function(a,b){setTimeout(function(){if(!a.isDefaultPrevented()){h()}},1)})});return d.api?e:this}})(jQuery);